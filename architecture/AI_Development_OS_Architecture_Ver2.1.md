# AI Development OS Architecture Ver.2.1 — Current State Integrated
...
document:
  ...
  human_companion: /home/baisound/projects/ai-team/architecture/AI_Development_OS_Architecture_Ver2.1.docx
  machine_path: /home/baisound/projects/ai-team/architecture/AI_Development_OS_Architecture_Ver2.1.md
  summary_path: /home/baisound/projects/ai-team/architecture/AI_Development_OS_Architecture_Ver2.1.summary.md
  historical_baseline: AI Development OS Architecture Ver.2.0
  baseline_commit: 3ce360ba5cef063cd046d88ce007d42c0b54a275
  coverage_evidence: /home/baisound/projects/javascript-roulette/docs/ai-team/tasks/TASK-004/document-version-coverage-ver1.1-to-ver1.2-reassessment-01.md
```
...
The inherited Ver.2.0 material below is preserved as historical architecture content. Where it describes TASK-004 Phase 1 as pending, the current sections appended after it supersede that historical progress statement. No historical evidence is altered by this notice.
...
## 49. Workspace, Foundation, and Project Boundaries

```text
/home/baisound                         Workspace Root
└── projects/
    ├── ai-team/                       Foundation Root
    ├── javascript-roulette/           Active Project Root
    └── other-projects/                Other Project Roots
```

The Workspace Root, Foundation Root, and Active Project Root are distinct. A resolver MUST NOT treat an untracked readable artifact as nonexistent, and MUST NOT cross a Project boundary without authority.
