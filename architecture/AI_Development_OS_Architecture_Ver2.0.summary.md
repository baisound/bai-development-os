...
- Source: `architecture/AI_Development_OS_Architecture_設計書_Ver2.0_持続可能開発・現状記録統合版.md`
- Category: `architecture`
- SHA-256: `1ae1803eebc26bac9ded0479b6d7167e624afb537fc5fc23c562a1a13cde381e`
...
This file provides an AI-oriented entry point to `AI_Development_OS_Architecture_設計書_Ver2.0_持続可能開発・現状記録統合版.md`. Load the full source only when the current assignment requires details not present here.
