...
TASK-018 is complete. For Closure or release verification, load `tasks/TASK-018/phase-i1-release-publication-evidence-2026-08-14.md` first, then the exact I1 decision, final-readiness JSON and Completion Record only as needed. Stable source-only `v1.1.0` targets exact main SHA `81a8445ab8a94fd75034e4c25b63eb7849f5608c`; it does not broaden TASK-036/M3B claims. TASK-017 resume still requires its separate pause/resume route and current Git re-audit.
