...
For current Consumer status, first load `tasks/TASK-018/post-release-bvp-v0.20.1-consumer-supplement-2026-08-14.md`. It records BAI VIDEO PRODUCTION release-code SHA `c2e12d59f869a6b612848aab7ba8319e9cb8a4b4`, stable Release `v0.20.1`, later documentation-main SHA `7873488c85cf1fd9e49b8061e4c201b6fec976d6`, and overall TASK-036/M3B `PASS`. For Phase G/H2 chronological provenance, then load the H2B Judge, `tasks/TASK-018/phase-g-consumer-release-closure-evidence-2026-08-14.md`, the final Pilot Context Cost and only the exact earlier parked W0/W1 Evidence needed. Do not reload raw Resolve/Cubase artifacts or superseded frontier documents unless a discrepancy requires them. A Draft PR's skipped matrix or stale checks never count as merge-ready; require fresh checks for the exact non-draft head.
